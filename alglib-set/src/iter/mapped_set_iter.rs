...
/// An auxiliary iterator used in [`FnSet`](crate::FnSet).
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct FnSetIter<B> {
    range_iter: IntRangeIter<usize>,
    backward: B,
}

impl<D, B> FnSetIter<B>
where
    B: Fn(usize) -> Option<D>,
{
...
impl<D, B> Iterator for FnSetIter<B>
where
    B: Fn(usize) -> Option<D>,
{
    type Item = D;
...
impl<D, B> DoubleEndedIterator for FnSetIter<B>
where
    B: Fn(usize) -> Option<D>,
{
    #[inline]
...
impl<D, B> ExactSizeIterator for FnSetIter<B>
where
    B: Fn(usize) -> Option<D>,
{
    #[inline]
...
impl<T, B> FusedIterator for FnSetIter<B> where B: Fn(usize) -> Option<T> {}
...
mod tests {
    ...
    fn grid_2d() {
        ...
        let mut iter = FnSetIter::new(9, backward);
    ...
    fn range() {
        ...
        let mut iter = FnSetIter::new(100, backward);
